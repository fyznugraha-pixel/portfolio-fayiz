...
export default function Projects({ projects }: { projects: Project[] }) {
  return (
    <>
      ...
      <div className="flex overflow-x-auto snap-x snap-mandatory hide-scrollbar gap-6 md:grid md:gap-12 md:grid-cols-3 md:overflow-visible py-32 -my-32 md:py-0 md:my-0 -mx-6 px-6 md:mx-0 md:px-0 relative z-0">
